...
def insert_packet_information(data):
    """
    Insert a new row into the Packet_Informations table.
    :param conn: Connection object to the database
    :param information: A tuple containing the data to insert (timestamp_imput_in_db, capture_interface_file)
    """

    sql_payload = '''
    INSERT INTO Packet_Informations (timestamp_imput_in_db, capture_interface_file)
    VALUES (?, ?)
    '''
